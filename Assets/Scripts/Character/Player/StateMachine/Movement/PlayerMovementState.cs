...
namespace ActionGame
{
    public class PlayerMovementState : IState
    {
        ...
        {
            if (stateMachine.Player.Targeter.targets.Count == 0)
            {
                return;
            }
        }
        ...
        protected virtual void AddInputActionsCallbacks()
        {
            ...
            stateMachine.Player.Health.OnTakeDamage += OnTakeDamage;
            stateMachine.Player.Health.OnDie += OnDeath;
        }
        ...
        {
            stateMachine.ChangeState(stateMachine.ImpactState);
        }
        ...
        private void Move()
        {
            if (stateMachine.ReusableData.ShouldAttack)
            {
                return;
            }
