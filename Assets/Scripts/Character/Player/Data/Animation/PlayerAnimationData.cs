...
public class PlayerAnimationData
{
    ...
    [SerializeField] private string blockingParameterName = "isBlocking";
    ...
    public int ImpactParameterHash { get; private set; }
    ...
    public void Initialize()
    {
        ...
        BlockingParameterhash = Animator.StringToHash(blockingParameterName);
    }
}
